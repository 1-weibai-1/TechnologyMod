...
public class PrimitiveForestLeaveDecorator extends LeaveVineDecorator {
	public static final PrimitiveForestLeaveDecorator INSTANCE = new PrimitiveForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("primitive_forest_tree_leave_decorator");
