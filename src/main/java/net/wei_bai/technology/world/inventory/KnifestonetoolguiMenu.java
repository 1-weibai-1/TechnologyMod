...
public class KnifestonetoolguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public KnifestonetoolguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TechnologyModMenus.KNIFESTONETOOLGUI, id);
		...
		this.customSlots.put(16, this.addSlot(new SlotItemHandler(internal, 16, 16, 53) {
		}));
		this.customSlots.put(17, this.addSlot(new SlotItemHandler(internal, 17, 34, 53) {
		}));
		this.customSlots.put(18, this.addSlot(new SlotItemHandler(internal, 18, 52, 53) {
		}));
		this.customSlots.put(19, this.addSlot(new SlotItemHandler(internal, 19, 70, 53) {
		}));
		this.customSlots.put(20, this.addSlot(new SlotItemHandler(internal, 20, 88, 53) {
		}));
		this.customSlots.put(21, this.addSlot(new SlotItemHandler(internal, 21, 106, 53) {
		}));
		this.customSlots.put(22, this.addSlot(new SlotItemHandler(internal, 22, 124, 53) {
		}));
		this.customSlots.put(23, this.addSlot(new SlotItemHandler(internal, 23, 142, 53) {
		}));
