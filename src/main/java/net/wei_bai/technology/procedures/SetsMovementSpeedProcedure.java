...
public class SetsMovementSpeedProcedure {
		...
		try {
			for (Entity entityiterator : EntityArgument.getEntities(arguments, "player")) {
				...
				if (entity instanceof Player _player && !_player.level.isClientSide())
					_player.displayClientMessage(new TextComponent(("\u4EE5\u5C06\u5B9E\u4F53" + entityiterator + "\u7684\u79FB\u52A8\u901F\u5EA6\u8BBE\u7F6E\u4E3A:\"" + DoubleArgumentType.getDouble(arguments, "order") + "\"")), (false));
			}
