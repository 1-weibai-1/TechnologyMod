...
public class ObstainFiberClothProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TechnologyModItems.SIMPLEWEAVINGMACHINE.get()
				&& (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == TechnologyModItems.FIBERBLOCKCLOTH.get()
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(TechnologyModItems.FIBERCLOTH.get());
