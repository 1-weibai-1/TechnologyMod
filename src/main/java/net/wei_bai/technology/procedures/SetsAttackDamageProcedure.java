...
public class SetsAttackDamageProcedure {
		...
		try {
			for (Entity entityiterator : EntityArgument.getEntities(arguments, "player")) {
				...
				if (entity instanceof Player _player && !_player.level.isClientSide())
					_player.displayClientMessage(new TextComponent(("\u4EE5\u5C06\u5B9E\u4F53" + entityiterator + "\u7684\u653B\u51FB\u4F24\u5BB3\u8BBE\u7F6E\u4E3A:\"" + DoubleArgumentType.getDouble(arguments, "order") + "\"")), (false));
			}
