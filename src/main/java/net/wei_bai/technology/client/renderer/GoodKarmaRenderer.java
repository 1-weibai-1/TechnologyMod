...
public class GoodKarmaRenderer extends EntityRenderer<GoodKarmaEntity> {
    ...
    public GoodKarmaRenderer(EntityRendererProvider.Context p_174110_) {
        super(p_174110_);
        this.shadowRadius = 0.15F;
        this.shadowStrength = 0.75F;
    }

    protected int getBlockLightLevel(GoodKarmaEntity p_114606_, BlockPos p_114607_) {
        return Mth.clamp(super.getBlockLightLevel(p_114606_, p_114607_) + 7, 0, 15);
    }

    public void render(GoodKarmaEntity p_114599_, float p_114600_, float p_114601_, PoseStack p_114602_, MultiBufferSource p_114603_, int p_114604_) {
        p_114602_.pushPose();
    ...
    public ResourceLocation getTextureLocation(GoodKarmaEntity p_114597_) {
